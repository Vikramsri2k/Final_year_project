...
#define WLAN_SSID       "VikramSri"
#define WLAN_PASS       "Vikram@14"

/************************* Adafruit.io Setup *********************************/

#define AIO_SERVER      "io.adafruit.com"
#define AIO_SERVERPORT  1883                   // use 8883 for SSL
#define AIO_USERNAME    "were"
#define AIO_KEY         "aio_knGZ33te6B9JQexV4qOpPD7YU6JN"
...
void loop() {
 ...
 // Now we can publish stuff!
  ...
  Serial.print("...");
  Serial.print("Sensor 2 ");Serial.println(Value);
  ...
  float millivolts=(analogvalue/1024.0)*2300;
 
  float celsius=millivolts/10;
  Serial.print("Sensor 3 ");Serial.println(celsius);
  if (! sensor_3.publish(celsius)) {
    Serial.println(F("Failed"));
  } else {
    Serial.println(F("OK!"));
  }
